 ...
 */
export class MSTouchUi extends Container {
	...
	public init() {
		...
		this.buttonFlag = new Button(this.app, this.app.getFrame("textures", "button-flag"));
		this.buttonFlag.tint = 0x444444;
		this.buttonFlag.x = -64;
		this.buttonFlag.y = 0;

		this.buttonDig = new Button(this.app, this.app.getFrame("textures", "button-dig"));
